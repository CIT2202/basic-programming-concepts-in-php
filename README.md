...
```
git clone https://github.com/CIT2202/basic-programming-concepts-in-php
```
...
- Make sure you can view _intro-to-php.php_ through a web browser e.g. http://localhost/basic-programming-concepts-in-php
- Answer the questions in _intro-to-php.php_.
